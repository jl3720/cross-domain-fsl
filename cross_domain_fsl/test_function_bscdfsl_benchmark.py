...
import random
import numpy as np
import cross_domain_fsl.data.feature_loader as feat_loader
from cross_domain_fsl.data.datamgr import SimpleDataManager
...
from cross_domain_fsl.options import parse_args, get_best_file, get_assigned_file
...
def test_bestmodel_bscdfsl(acc_file, name, dataset, n_shot, save_epoch=-1):
    ...
    print(
        "Testing! {} shots on {} dataset with {} epochs of {}".format(
